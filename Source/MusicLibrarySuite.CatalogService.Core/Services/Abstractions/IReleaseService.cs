...
public interface IReleaseService
{
    ...
    /// </returns>
    public Task<ReleasePageResponse> GetReleasesAsync(ReleasePageRequest releasePageRequest);
    ...
    /// </returns>
    public Task<bool> UpdateReleaseMediaToProductRelationshipsOrderAsync(ReleaseMediaToProductRelationship[] releaseMediaToProductRelationships, bool useReferenceOrder = false);
    ...
    /// </returns>
    public Task<bool> UpdateReleaseTrackToProductRelationshipsOrderAsync(ReleaseTrackToProductRelationship[] releaseTrackToProductRelationships, bool useReferenceOrder = false);
    ...
    /// </returns>
    public Task<bool> UpdateReleaseTrackToWorkRelationshipsOrderAsync(ReleaseTrackToWorkRelationship[] releaseTrackToWorkRelationships, bool useReferenceOrder = false);
