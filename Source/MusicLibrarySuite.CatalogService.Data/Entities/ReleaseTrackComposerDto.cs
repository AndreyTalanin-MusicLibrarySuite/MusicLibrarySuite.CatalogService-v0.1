...
/// <summary>
/// Represents a database model and a data transfer object for a release-track-to-artist relationship where the artist has the "composer" role.
/// </summary>
public class ReleaseTrackComposerDto
{
    /// <summary>
