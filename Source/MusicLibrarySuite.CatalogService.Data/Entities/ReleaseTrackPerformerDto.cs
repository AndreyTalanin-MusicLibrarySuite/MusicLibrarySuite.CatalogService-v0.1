...
/// <summary>
/// Represents a database model and a data transfer object for a release-track-to-artist relationship where the artist has the "performer" role.
/// </summary>
public class ReleaseTrackPerformerDto
{
    /// <summary>
