...
/// </summary>
public partial class ReleaseTrackToWorkRelationshipsMigration : Migration
{
    /// <inheritdoc />
                ...
                (
                    SELECT
                        ...
                        COALESCE([targetReleaseTrackToWorkRelationship].[ReferenceOrder],
                            MAX([workReleaseTrackToWorkRelationship].[ReferenceOrder]) + 1,
                            0) AS [ReferenceOrder]
                    ...
                    WHERE [sourceReleaseTrackToWorkRelationship].[ReleaseId] = @Id
                    GROUP BY
                        [sourceReleaseTrackToWorkRelationship].[TrackNumber],
                        [sourceReleaseTrackToWorkRelationship].[MediaNumber],
                        [sourceReleaseTrackToWorkRelationship].[ReleaseId],
