...
/// </summary>
public partial class ReleaseTrackToProductRelationshipsMigration : Migration
{
    /// <inheritdoc />
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    ...
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
                table.CheckConstraint("CK_ReleaseTrackToProductRelationship_Name", "LEN(TRIM([Name])) > 0");
                table.CheckConstraint("CK_ReleaseTrackToProductRelationship_Description", "[Description] IS NULL OR LEN(TRIM([Description])) > 0");
            });
        ...
        migrationBuilder.Sql(@"
            ...
            BEGIN
                ...
                (
                    ...
                    WHERE [sourceReleaseTrackToProductRelationship].[ReleaseId] = @Id
                    GROUP BY
                        [sourceReleaseTrackToProductRelationship].[TrackNumber],
                        [sourceReleaseTrackToProductRelationship].[MediaNumber],
                        [sourceReleaseTrackToProductRelationship].[ReleaseId],
